...
export default function Home() {
  return (
    <main
      className="relative h-[100svh] w-screen overflow-x-hidden"
      style={{
      ...
      <div className="w-full h-full max-w-2xl mx-auto">
        <div className="flex flex-col w-full h-full items-center justify-between p-4">
          ...
          <div className="flex flex-1 justify-end flex-col gap-2 w-full">
            <Notification
              title="Nicolas Alonso Froeling"
              icon="/profile-img.JPG"
              delay={0.5}
              description={
                <>
                  Fullstack developer studying Computer Science and Minor in
                  Applied Math.
                  <br />
                  Playing golf in the athletic golf team at Wentworth Institute
                  of Technology.
                  <br />
                  Surfing whenever I have time.
                  <br />I have created some AI Mobile Applications and web apps.
                  Very interested in Mobile Development and Software Backend.
                </>
              }
            />
            <Notification
            ...
            <Notification
              title="LinkedIn"
              link="https://www.linkedin.com/in/nalonsofroeling/"
              delay={1.5}
              icon="/linkedin.png"
...
function Notification(props: NotificationProps) {
  return (
    <motion.div
      ...
      transition={{ delay: props.delay, ease: "easeIn" }}
    >
      {props.link ? (
        <Link href={props.link} target="_blank">
          <div className="flex w-full justify-center items-start bg-zinc-800/40 rounded-[1.75rem] backdrop-blur-md p-4">
            <Image
              ...
              width={75}
              height={75}
              className="rounded-full md:h-[64px] md:w-[64px] h-[44px] w-[44px]"
            />
            <div className="flex flex-col w-full pl-2">
              <div className="flex w-full justify-between items-center px-2">
                ...
                <p className="md:text-sm text-xs px-2 text-zinc-300">now</p>
              </div>
